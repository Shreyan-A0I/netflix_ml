This dataset consists of tv shows and movies available on Netflix as of 2019. The dataset is collected from Kaggle (Netflix_titles excel) and cia_gov(Country_codes).
